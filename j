  ...
  stage ('Check-Git-Secrets') {
      steps {
       // sh 'rm trufflehog || true'
        sh 'sshpass -p Stellantis01 ssh devuser@10.109.137.30 "sudo docker run --rm -it  dxa4481/trufflehog:latest --json https://github.com/abhi3780/webapp.git > trufflehog"'

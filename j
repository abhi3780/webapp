  ...
  stages {
   ...
   stage ('Build') {
    ...
    stage ('Infra Scan') {
       ...
       stage ('QualysGuard') {
           steps {
            qualysVulnerabilityAnalyzer apiServer: 'https://qualysapi.qualys.com', credsId: 'Qualys', hostIp: '10.109.137.30', network: 'ACCESS_FORBIDDEN', optionProfile: 'Initial Options', platform: 'US_PLATFORM_1', pollingInterval: '2', proxyCredentialsId: 'Qualys', proxyPort: 9080, proxyServer: 'aiproxy.appl.chrysler.com', scanName: 'test123', scannerName: 'N_AZURE_1', useHost: true, useProxy: true, vulnsTimeout: '60*10'

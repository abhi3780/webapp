  ...
  stages {
    ...
    stage ('DAST') {
      steps {
         ...
         sh 'sshpass -p Stellantis01 ssh devuser@10.109.137.30 "cp -r /arachni/*.afr /arachni/bin/ && /arachni/bin/./arachni_reporter *.afr --reporter=html:outfile=*.html && rm -r /arachni/*.afr && rm -r /arachni/bin/*.afr" '
         sh 'sshpass -p Stellantis01 ssh devuser@10.109.137.30 "cp -r /arachni/bin/*.html /home/reports/ && rm -r /arachni/bin/*.html" '
